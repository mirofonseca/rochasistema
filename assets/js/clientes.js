...
async function abrirModalCliente(e){if(document.getElementById("cl-id").value="",document.getElementById("modal-cliente-titulo").textContent="Novo Cliente",["cl-nome","cl-cpf","cl-tel","cl-email","cl-cep","cl-end","cl-cidade","cl-cnh","cl-obs","cl-renavan","cl-placa-veiculo"].forEach(e=>document.getElementById(e).value=""),document.getElementById("cl-cat").value="",e){const t=_clCache.find(t=>t.id===e);t&&(document.getElementById("cl-id").value=e,document.getElementById("modal-cliente-titulo").textContent="Editar Cliente",document.getElementById("cl-nome").value=t.nome||"",document.getElementById("cl-cpf").value=t.cpf||"",document.getElementById("cl-tel").value=t.tel||"",document.getElementById("cl-email").value=t.email||"",document.getElementById("cl-cep").value=t.cep||"",document.getElementById("cl-end").value=t.endereco||"",document.getElementById("cl-cidade").value=t.cidade||"",document.getElementById("cl-cnh").value=t.cnh||"",document.getElementById("cl-cat").value=t.cat_cnh||"",document.getElementById("cl-renavan").value=t.renavan||"",document.getElementById("cl-placa-veiculo").value=t.placa_veiculo||"",document.getElementById("cl-obs").value=t.obs||"")}abrirModal("modal-cliente")}
...
async function salvarCliente(){const e=document.getElementById("cl-nome").value.trim(),t=document.getElementById("cl-tel").value.trim();if(!e)return void toast("Informe o nome","error");if(!t)return void toast("Informe o telefone","error");const a={nome:e,cpf:document.getElementById("cl-cpf").value.trim(),tel:t,email:document.getElementById("cl-email").value.trim(),endereco:document.getElementById("cl-end").value.trim(),cidade:document.getElementById("cl-cidade").value.trim(),cep:document.getElementById("cl-cep").value.trim(),cnh:document.getElementById("cl-cnh").value.trim(),cat_cnh:document.getElementById("cl-cat").value,renavan:document.getElementById("cl-renavan").value.trim(),placa_veiculo:document.getElementById("cl-placa-veiculo").value.trim(),obs:document.getElementById("cl-obs").value},n=document.getElementById("cl-id").value;try{n?(await api.put(`/api/clientes/${n}`,a),toast("Cliente atualizado!","success")):(await api.post("/api/clientes",a),toast("Cliente cadastrado!","success")),fecharModal("modal-cliente"),await renderClientes()}catch(e){toast(e.message,"error")}}
